...
function makeStyles(colors) {
  ...
  visibilityOptionActive: { borderColor: colors.accent, backgroundColor: colors.accentDim ?? 'rgba(52,211,153,0.08)' },
  ...
  clubOptionSelected: { backgroundColor: colors.accentDim ?? 'rgba(52,211,153,0.08)' },
