...
function makeStyles(colors) {
  return StyleSheet.create({
    ...
    previewLabel: { fontSize: 11, fontWeight: '700', color: colors.accent, letterSpacing: 0.5 },
    ...
    sectionLabel: { fontSize: 12, fontWeight: '700', color: colors.textMuted, letterSpacing: 0.5, marginBottom: 8 },
